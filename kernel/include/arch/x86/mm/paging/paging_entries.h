...
namespace paging
{
    ...
    inline constexpr std::size_t PAGE_MEDIUM_TO_SMALL_RATIO = PAGE_MEDIUM_SIZE / PAGE_SMALL_SIZE;
    inline constexpr std::size_t PAGE_LARGE_TO_MEDIUM_RATIO = PAGE_LARGE_SIZE / PAGE_MEDIUM_SIZE;
    inline constexpr std::size_t PAGE_LARGE_TO_SMALL_RATIO = PAGE_LARGE_SIZE / PAGE_SMALL_SIZE;
